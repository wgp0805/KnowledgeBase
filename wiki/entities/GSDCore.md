...
[[MattPocock]] 的 `mattpocock/skills` 仓库将 GSD 归类为"接管流程"的重量级框架，批评其"帮你接管整套流程，代价是控制权被拿走，流程本身出了 bug 你还很难修"。Matt 主张 skill 应该是"小、可改、可组合、跨模型"的纪律箱，而非控制流程的框架。这一批评反映了两种设计哲学的分野：**框架接管 vs 纪律工具箱**。
