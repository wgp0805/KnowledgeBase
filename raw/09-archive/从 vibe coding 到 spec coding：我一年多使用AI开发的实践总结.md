---
title: "从 vibe coding 到 spec coding：我一年多使用AI开发的实践总结"
source: "https://mp.weixin.qq.com/s/lR26p3GAdqhm5aUUz5YLQg"
---
Java技术指北 *2026年7月15日 08:15*
...
所以我觉得不管我们用的是 claude code、cursor 还是 codex，不管模型是 fable 5 还是 [gpt-5.6，只是单纯的](http://gpt-5.xn--6,-w65c2vz44e1mwgwm/) vibe的话，写出来的代码感觉基本都差不多。一个人写还能凑合，团队用基本是灾难了。
...
![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/040ff526d911df5432a315a331be049e_MD5.webp)
...
所以我们就需要用一些技能插件来辅助 ai 更好的遵循规范化写代码。比如我们可以通过维护 [CLAUDE.md和](http://claude.xn--md-ky6c/) [AGENTS.md来声明项目规则等，又比如我们再通过写](http://agents.xn--md,-rt9d73jcc22ct2hmyp2mbvz5c63kmlefrt5i3b0tor71d0vwabnbi26g/) rules 文件、用 skill、再加 hook来给 ai 套上一层约束。但是单用某几个的时候其实还是有一些局限性。
...
### 关于 AGENTS.md / CLAUDE.md / rules 的价值和局限
...
就像 `.cursorrules` 、 `              CLAUDE.md            ` 这类文件更偏平台专属。比如我之前写的系列文章， 通过在 claude code 里面配置 [AGENTS.md](http://agents.md/) / [CLAUDE.md](http://claude.md/) 以及在.claude下面配置项目级别的 rules，hook，和 skill 等。
...
我们经常性需要新开会话继续沟通，但是每次新开一个窗口会话，ai 就会忘记之前的进度和背景，要么我们需要沟通的同时去维护一个 [plan.md](http://plan.md/) 跟进进度，要么就是我们重新总结一下上一个会话的内容和总结，然后再让新的会话继续执行。
...
![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/cc14c2b8e0e71a1bcaac2e075507f96c_MD5.jpg)
...
![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/34562672dc5b08061d4517512abe3239_MD5.jpg)
...
![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/8267c6aa7580e30bb77e1de2749f7170_MD5.png)![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/dbf6b1218858bad7037b980c9cc21ed4_MD5.png)
...
![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/e696e64e3ecbba212eeb65696193a87e_MD5.png)
...
> 因为它主要靠仓库根目录的 `              AGENTS.md            ` 做 prelude， 再通过 `UserPromptSubmit` hook 注入 workflow-state的，新版本 codex cli 里 hooks 可能已经默认开启了。但如果 / 菜单里看不到 trellis 的 command / skill，或者 workflow 指引没有自动注入，我们可以通过检查 ~/.codex/ [config.toml](http://config.toml/) 里是否开启了 [features.hooks](http://features.hooks/) = true。 并通过 /hooks 审批 trellis 安装的 hook。即便 hook 没跑起来，trellis 仍然可以通过 [AGENTS.md](http://agents.md/) fallback 让 ai 读取 trellis-start，只是体验会弱一些。
...
![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/4a1fb089c375fdb6140708ca260005de_MD5.png)
...
![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/8f5835e1aeeba4cef596cea1063df70b_MD5.png)
...
![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/bba303b2bf0e09848f0a0d32ab31421d_MD5.png)
...
![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/2ddf8a81907087b72939e361fee1bbea_MD5.jpg)

这里如果还有想要了解到可以看下官方文档说明 ： [https://docs.trytrellis.app/zh/start/how-it-works](https://docs.trytrellis.app/zh/start/how-it-works)
...
![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/8e7f1d5d8a14292f642f93b7923dbcc5_MD5.jpg)
...
![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/842b22201725173d3027ecd8c2bcbd05_MD5.jpg)
...
本来我比较喜欢使用 claude code 进行开发的，但是前段时间说有漏洞，再加上最近没有 claude 模型可以用了，所以我也会用 codex 开发，甚至也会用到 cursor，但是每次换工具，我都要把之前在 `.cursorrules` 里配的规范，重新写成 `              CLAUDE.md            ` 。这点其实我觉得可以通过 [AGENTS.md来维护，但是](http://agents.xn--md,-139di99ftxe5lcs93f/) claude code 项目级别的 rules skill 就不行了。
...
![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/b0719b4e60a53ef0398b9bfccad97e68_MD5.jpg)
...
![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/3a3ff6a959accaedd4e6504eb8e6b29d_MD5.jpg)
...
![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/44c7e4aa0c2d47e00fe01806a5126cfa_MD5.jpg)
...
trellis 是 skill-first 的，很多能力会根据上下文自动触发。其他的命令可以通过官方文档进行了解。这里我不再过多讲述： [https://docs.trytrellis.app/zh/start/real-world-scenarios](https://docs.trytrellis.app/zh/start/real-world-scenarios)
...
本文转自： [https://linux.do/t/topic/2571606](https://linux.do/t/topic/2571606)
...
普通人现在还有没有“确定性更高”的副业机会？

我目前在做的，是 AI + 跨境这条线。

它的核心不是“新”，而是：

在一个更大的市场，用更高效的工具，把一件传统生意重做一遍。
...
我整理了一份《AI跨境搞钱手册》，把整个0-1路径讲清楚了，

加我微信，直接拿。

![图片](assets/%E4%BB%8E%20vibe%20coding%20%E5%88%B0%20spec%20coding%EF%BC%9A%E6%88%91%E4%B8%80%E5%B9%B4%E5%A4%9A%E4%BD%BF%E7%94%A8AI%E5%BC%80%E5%8F%91%E7%9A%84%E5%AE%9E%E8%B7%B5%E6%80%BB%E7%BB%93/20dbcfa99a579959118c4480eba1c3f8_MD5.png)