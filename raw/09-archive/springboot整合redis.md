...
##### 创建 RedisTemplate Bean（也可以选择通过配置类进行配置）
...
转载自：[RedisTemplate操作Redis，这一篇文章就够了（一）-CSDN博客](https://blog.csdn.net/lydms/article/details/105224210)
