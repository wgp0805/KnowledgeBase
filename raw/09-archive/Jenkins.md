...
```
sudo EXTERNAL_URL="http://192.168.75.131" yum install -y gitlab-jh
```
...
将jenkins上传在`/home`目录下，然后执行 `java -jar jenkins.war` 就可以了
...
![image-20220726213303821](assets/Jenkins/image-20220726213303821.png)



![image-20220726213505879](assets/Jenkins/image-20220726213505879.png)
...
![image-20220726214239888](assets/Jenkins/image-20220726214239888.png)
...
![image-20220726214200732](assets/Jenkins/image-20220726214200732.png)
...
![image-20220726223917263](assets/Jenkins/image-20220726223917263.png)

![image-20220726223937722](assets/Jenkins/image-20220726223937722.png)

3 修改配置

![image-20220727165700419](assets/Jenkins/image-20220727165700419.png)
...
![image-20220728170250273](assets/Jenkins/image-20220728170250273.png)
