---
title: "Responses API 和 Chat Completions API 有什么区别？"
source: "https://javabetter.cn/ai/video/responses-api-vs-chat-completions.html"
---
...
![](assets/Responses%20API%20%E5%92%8C%20Chat%20Completions%20API%20%E6%9C%89%E4%BB%80%E4%B9%88%E5%8C%BA%E5%88%AB%EF%BC%9F/6c57882cf84732e2ebb7daf97ad12dab_MD5.png)
...
Responses API 不一样。它把每种输出拆成了独立的类型——文本回复是 message，推理过程是 reasoning，工具调用是 function\_call，生成图片是 image\_generation\_call。各管各的，互不干扰。
...
![](assets/Responses%20API%20%E5%92%8C%20Chat%20Completions%20API%20%E6%9C%89%E4%BB%80%E4%B9%88%E5%8C%BA%E5%88%AB%EF%BC%9F/5e5586d1855f981e5e69de453ae5a792_MD5.png)
...
Responses API 给了一个新的选项：previous\_response\_id。你只需要告诉服务端"上一轮的响应 ID 是什么"，服务端通过 id 去它自己记录的上下文信息里去找，不用你重发。
...
以前你想在 Codex 里用国产模型，中间得加一层代理进行格式转换。现在 DeepSeek V4 Pro 原生支持了，改一下 base\_url 就能直接用，不用再做任何适配。
