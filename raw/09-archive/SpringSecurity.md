...
![image-20230410140908841](assets/SpringSecurity/image-20230410140908841.png)
...
![image-20231130152247055](assets/SpringSecurity/image-20231130152247055.png)

否则你的登录页会加载很久，并且看到的页面是这样的（登录按钮没有样式文件渲染，但是不影响登录功能的执行）

![image-20231130152345471](assets/SpringSecurity/image-20231130152345471.png)
...
![filterchain](assets/SpringSecurity/filterchain.png)
...
![delegatingfilterproxy](assets/SpringSecurity/delegatingfilterproxy.png)
...
![filterchainproxy](assets/SpringSecurity/filterchainproxy.png)
...
![securityfilterchain](assets/SpringSecurity/securityfilterchain.png)
...
![multi securityfilterchain](assets/SpringSecurity/multi-securityfilterchain-17016804731631.png)
...
![image-20231204230216259](assets/SpringSecurity/image-20231204230216259.png)
...
![image-20231205164049257](assets/SpringSecurity/image-20231205164049257.png)
...
![image-20231206022701725](assets/SpringSecurity/image-20231206022701725.png)
...
![image-20231206023030864](assets/SpringSecurity/image-20231206023030864.png)
...
![image-20230421184645177](assets/SpringSecurity/image-20230421184645177.png)
...
![image-20231209011827867](assets/SpringSecurity/image-20231209011827867.png)
...
![usernamepasswordauthenticationfilter](assets/SpringSecurity/usernamepasswordauthenticationfilter-16822329079281.png)
...
![securitycontextholder](assets/SpringSecurity/securitycontextholder.png)
...
![image-20231222124053994](assets/SpringSecurity/image-20231222124053994.png)
...
![image-20231222131233025](assets/SpringSecurity/image-20231222131233025.png)

##### 开放API

例如云冲印服务的实现

![image-20231222131118611](assets/SpringSecurity/image-20231222131118611.png)

#### 现代微服务安全

##### 单块应用安全

![image-20231222152734546](assets/SpringSecurity/image-20231222152734546.png)



##### 微服务安全

![image-20231222152557861](assets/SpringSecurity/image-20231222152557861.png)
...
![image-20231220180422742](assets/SpringSecurity/image-20231220180422742.png)



- 注册客户应用：客户应用如果想要访问资源服务器需要有凭证，需要在授权服务器上注册客户应用。注册后会**获取到一个ClientID和ClientSecrets**

![image-20231222203153125](assets/SpringSecurity/image-20231222203153125.png)
...
​								![image-20231220185958063](assets/SpringSecurity/image-20231220185958063.png)



![image-20231222203218334](assets/SpringSecurity/image-20231222203218334.png)
...
![image-20231220190152888](assets/SpringSecurity/image-20231220190152888.png)

![image-20231222203240921](assets/SpringSecurity/image-20231222203240921.png)
...
![image-20231222203259785](assets/SpringSecurity/image-20231222203259785.png)



### 1.5、授权类型的选择

![image-20231223020052999](assets/SpringSecurity/image-20231223020052999.png)
...
![image-20231223164128030](assets/SpringSecurity/image-20231223164128030.png)
...
![image-20230510154255157](assets/SpringSecurity/image-20230510154255157.png)



填写应用信息：`默认的重定向URI模板为{baseUrl}/login/oauth2/code/{registrationId}`。registrationId是ClientRegistration的唯一标识符。

![image-20231221000906168](assets/SpringSecurity/image-20231221000906168.png)

获取应用程序id，生成应用程序密钥：

![image-20230510163101376](assets/SpringSecurity/image-20230510163101376.png)
...
![image-20230510165314829](assets/SpringSecurity/image-20230510165314829.png)
...
![image-20231223203225688](assets/SpringSecurity/image-20231223203225688.png)
