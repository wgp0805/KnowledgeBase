#!/usr/bin/env python3
"""Update SkyWalking.md with Java Agent and Web UI info"""
import re

with open('wiki/entities/SkyWalking.md', 'r', encoding='utf-8') as f:
    content = f.read()
...
content = content.replace('last_updated: 2026-07-23', 'last_updated: 2026-07-27')
...
with open('wiki/entities/SkyWalking.md', 'w', encoding='utf-8') as f:
    f.write(content)

print('SkyWalking.md updated successfully')